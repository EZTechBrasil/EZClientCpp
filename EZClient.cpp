...
int CEZClient::LoadAPIs( char* dllpath )
{
	...
	GetNextDeliveryEventEx4=(typeGetNextDeliveryEventEx4) GetProcAddress(dllHandle,"GetNextDeliveryEventEx4");
	if( GetNextDeliveryEventEx4==NULL) return -1213;

	GetNextPumpEventEx3=(typeGetNextPumpEventEx3) GetProcAddress(dllHandle,"GetNextPumpEventEx3");
	if( GetNextPumpEventEx3==NULL) return -1214;

	GetGradePropertiesEx=(typeGetGradePropertiesEx) GetProcAddress(dllHandle,"GetGradePropertiesEx");
